...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 커스텀마이징한 액선바를 사용하겠다는 의미
        Toolbar main_toolbar = findViewById(R.id.main_toolbar);
        setSupportActionBar(main_toolbar);

        /**
         * 새오운 Activity가 열렸을때 이전 Activity로 돌아가기 아이콘을 표시하기
...
//        actionBar.setDisplayHomeAsUpEnabled(true);
        ...
        cacaoAdapter = new CacaoAdapter(cacaoList, nickname);
    ...
    /**
     * custom한 Toolbar가 (Main_Activity에 적용될 때
     *     setSupportActionBar() method가 실행될 때
     *     event가 발생하고 자동으로 호출되는 method
     *
     *     Toolbar를 사용하여 ActionBar를 Custom하는 이유중의 하나가
     *     onCreateOptionsMenu() method를 Override하여
     *     더욱 세밀한 Customizing을 하기 위해 사용
     *
