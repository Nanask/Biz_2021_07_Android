...
import com.nana.movies.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        // searchView 클래스가 지정된 itme을 가져와서
        // searchView 객체로 생성하기
        ...
        searchView.setQueryHint("영화검색");

        // 검색창에 검색어를 입력하고 키보드의 검색(search icon)을 클릭했을 때 반응하는 event 핸들러
        // 검색창에 문자열을 입력할 때, 검색을 클릭했을 대 반응하는 event
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String s) {
                ...
                if(s.isEmpty() == false) {
                    ...
                    // 다른 액션을 취하지말고 secondFragment를 열어라
