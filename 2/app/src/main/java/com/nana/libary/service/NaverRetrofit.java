...
public interface NaverRetrofit {
    ...
    /**
     * method의 return type을 void 형식이 아닌 call 클래스 type으로 설정
     */
    // 1. 가장 기본 타입, 아무일도 할 수 없음
    public Call getBook();

    /**
     * 2. naver openAPI를 사용하기 위해서는
     * 반드시 header에 Client ID와 Client Secret값을 전달해 주어야 한다.
     ...
     *      X-Naver-Client-Id=dddsfefwef 형식으로 요청한다.
     *
     ...
     *
     *  5. return type인 Call 클래스에 Data를 mapping할 DTO(VO) 클래스를 Generic으로 설정해 준다.
     */
