...
public interface WordDao {
     ...
     * 이는 메모리에 부담이 되고 디바이스 시스템에 무리를 줄 수 있다.
     *
     * 하지만 LiveDate로 감싼 리스트는 안드로이드 OS 차원에서
     * 적적히 메모리를 분배하여 리스트를 관리해주는 효과가 있다.
     *
     * 리스트를 보고 있는 동안에 새로운 데이터가 insert가 되었다면
